              ...
              child: SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                      Row(
                          children: [
                            drink.cold ? Image.network("https://github.com/loloneme/images/blob/main/cold.png?raw=true",
                              width: 35,
                              height: 35,
                              fit: BoxFit.cover,
                            ) : Container(),
                            drink.hot ? Image.network("https://github.com/loloneme/images/blob/main/hot.png?raw=true",
                              width: 35,
                              height: 35,
                              fit: BoxFit.cover,
                          ...
                          children: drink.prices.entries.map((entry) {
                            return Padding(
                              ...
                              child: Column(
                                    ...
                                    children: [
                                      Text("${entry.key}мл", style: GoogleFonts.sourceSerif4(
                                    textStyle: const TextStyle(
                                      ...
                                      Text('${entry.value}₽', style: GoogleFonts.sourceSerif4(
                                  textStyle: const TextStyle(
                                      fontSize: 18,
